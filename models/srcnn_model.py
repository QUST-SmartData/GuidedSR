...
class SRCNNModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        if is_train:
            ...
            parser.add_argument('--lambda_img_grad', type=float, default=0.0, help='weight to image gradient penalty') #加权图像梯度惩罚
    ...
    def __init__(self, opt):
        ...
        self.visual_names = ['data_A_orig', 'data_B', 'fake_B']
        
        self.model_names = ['G'] # Models you want to save to disk.
        
        # define networks; you can use opt.isTrain to specify different behaviors for training and test.
        self.netG = networks.define_G(opt.input_nc, opt.output_nc, opt.ngf, opt.netG, gpu_ids=self.gpu_ids, ds_fac=opt.downsample_factor)

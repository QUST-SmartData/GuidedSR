...
class SRResnetGenerator(nn.Module):
    ...
    def forward(self, input):
        ...
        z = torch.cat([x, y], 0)
        m11 = a1 + self.model11(z)

        a2 = self.LRmodel2(m11)
        b2 = self.ssmodel2(b1)
        ...
        z = torch.cat([x, y], 0)
        m22 = a2 + self.model22(z)

        a3 = self.LRmodel3(m22)
        b3 = self.ssmodel3(b2)
        ...
        z = torch.cat([x, y], 0)
        m33 = a3 + self.model33(z)

        a4 = self.LRmodel4(m33)
        b4 = self.ssmodel4(b3)
        ...
        z = torch.cat([x, y], 0)
        m44 = a4 + self.model44(z)

        a5 = self.LRmodel2(m44)
        b5 = self.ssmodel2(b4)

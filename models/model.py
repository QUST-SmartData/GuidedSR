...
class SRGANModel(BaseModel):
    ...
    def modify_commandline_options(parser, is_train=True):
        ...
        parser.set_defaults(ngf=64, norm='batch')
        return parser
    ...
    def backward_D(self):
        ...
        self.loss_D_fake = networks.losses_computer.loss(pred_fake, self.real_SSHR, for_real=False)
        # Real
        real_B = self.real_B
    ...
    def backward_G(self):
        ...
        self.loss_G_GAN = networks.losses_computer(pred_fake, self.real_SSHR, for_real=True)
        # Second, G(A) = B
